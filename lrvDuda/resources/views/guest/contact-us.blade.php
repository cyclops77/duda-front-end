				              	...
				              	<form class="form theme-form-style-one" id="contact-form" action="inc/contact.php" data-toggle="validator">
				                	...
				                	<div class="controls control-custom">
					                    <div class="form-group form-group-custom">
					                        <input id="form_email" class="sm-input-custom" type="email" name="email" placeholder="Email Address*" required="required" data-error="Valid email is required.">
					                    ...
					                    <button class="theme-btn solid-button-one radius3" style="margin-top: -20px;">
					                    	Kirim Pesan >
				                    	</button>
				                	</div> <!-- /.controls -->
				              	</form>

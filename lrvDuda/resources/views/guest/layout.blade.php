								              	...
								              	<div class="row">
									                <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3 mt-lg-3 mb-lg-3">
									                	<a href="{{url('service-one')}}" class="img-box">
									                		<span class="img"><img src="{{asset('Rogan/rogan-c/html/images/menu-img/home-1.jpg')}}" alt=""></span>
									                		<span class="text">Business Agency</span>
									                	</a>
									                </div>
									                <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3 mt-lg-3 mb-lg-3">
									                	<a href="{{url('service-two')}}" class="img-box">
									                		<span class="img"><img src="{{asset('Rogan/rogan-c/html/images/menu-img/home-2.jpg')}}" alt=""></span>
									                ...
									                <div class="col-lg-3 col-md-4 col-sm-6 mt-3 mb-3 mt-lg-3 mb-lg-3">
									                	<a href="service-v3.html" class="img-box">
									                		<span class="img"><img src="{{asset('Rogan/rogan-c/html/images/menu-img/home-8.jpg')}}" alt=""></span>
